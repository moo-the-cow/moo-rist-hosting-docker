...
**Current version docker:** `0.0.32` ⚠️Please update to 0.0.32 or higher version if you use an earlier one, there has been a vital update by the author


**libRIST library:** `0.2.19-rc2-27-gafdc7ed` **API version:** `4.12.0`
